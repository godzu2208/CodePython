...
# output_file = 'D:\Laptop\Công việc\papercut\weekly\summary3.xlsx'
...
# Đọc file Excel
file_path = 'D:\Laptop\Công việc\papercut\input\print_logs.xlsx'
# file_path = 'D:\Laptop\Công việc\papercut\weekly\print_logs.xlsx'  # Đặt đường dẫn đến file Excel của bạn ở đây
df = pd.read_excel(file_path)
...
# Đảm bảo tất cả giá trị trong cột Document là chuỗi
...
# Lưu kết quả vào file Excel mới
output_file = 'D:\Laptop\Công việc\papercut\weekly\summary09112024.xlsx'
summary.to_excel(output_file, index=False)
